 ...
 * {@code services/reference-service/src/main/resources/db/migration/V1__reference.sql} L178
 * {@code type_cd CHAR(2) NOT NULL}, L203 {@code cat_cd CHAR(4) NOT NULL} and L209
...
public final class TransactionCategoryMapper {
     ...
     * L178, L203 and L209 and the entity repeats each constraint as {@code nullable = false}. Nothing
    ...
    public static TransactionCategoryResponse toResponse(TransactionCategory entity) {
        ...
        //       TRC_TYPE_CATEGORY), carried forward at V1__reference.sql L234 -- and half of the
        ...
        //       against V1__reference.sql L223, and the replace operation answers 409 carrying it --
     ...
     * L223 defaults the column to zero, after which the persistence provider owns it.</p>
     *
    ...
    public static TransactionCategory toNewEntity(TransactionCategoryCreateRequest request) {
        ...
        //       type its categories still reference, V1__reference.sql L266 to L268 carries that
     ...
     * {@code V1__reference.sql} L234, and the entity maps both key columns {@code updatable = false}
