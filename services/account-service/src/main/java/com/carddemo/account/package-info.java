/**
 * The root package of the account, customer and card-cross-reference context, holding its single Spring Boot entry point.
 *
 * <h2>What lives here, and what deliberately does not</h2>
 *
 * <p>This package holds two compilation units and no more -- {@code AccountApplication}, and this
 ...
 *
 * <p>Assumptions: the component scan is rooted HERE, at com.carddemo.account, and is never widened. Every
