/**
 * The root package of the sign-on and user-administration context, holding its single Spring Boot entry point.
 *
 * <h2>What lives here, and what deliberately does not</h2>
 *
 * <p>This package holds two compilation units and no more -- {@code AuthApplication}, and this
 ...
 *
 * <p>Assumptions: the component scan is rooted HERE, at com.carddemo.auth, and is never widened. Every
