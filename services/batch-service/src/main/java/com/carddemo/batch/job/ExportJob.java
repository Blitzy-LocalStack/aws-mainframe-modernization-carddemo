 ...
 * quiesce, stage, preflight, post, interest, backup, combine, statements, reports, analyze
 * and resume -- the whole-migration verification gate runs inside the stage state rather than
 * beside it; export and import are not among them. Assumptions: this job is reachable only through the
