 ...
 *
 * <p>Assumptions: money is {@code BigDecimal} at scale 2 under ONE rounding contract, fixed at the
 * shared type and reachable from no signature.
 * {@code com.carddemo.common.money.Money#GENERAL_ROUNDING} is half up and governs every reduction --
 * the reduction of a supplied amount, general multiplication and division, and the accrual quotient
 * alike. {@code double} and {@code float} are forbidden in the money path and an architecture test
