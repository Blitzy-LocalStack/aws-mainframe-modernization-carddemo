...
terraform {
  ...
  required_providers {
    ...
    # WHY : Assumptions: `source` is written out instead of being left to
    ...
    #      every module was rejected. This module creates no random
  ...
  #      Assumptions: the calling root configures exactly one default aws
